...
class Live (object):
    ...
    def create_position(self, direction=None, market=None, leverage=None, size=None, entry_price=None, stop_loss=None, stop_loss_trailing=None, take_profit=None, key=None):
        """
        ...
        # test market value
        if market is None:
            print("\nError, please enter a market parameter value. Remember that you can also fetch available market symbol using get_markets().\n")
            return
        else:
            d['market'] = str(market)
        ...
        if leverage is None or leverage < 0:
            print("\nError, please enter a correct leverage value. Remember that you can also fetch available market leverage max using get_markets().\n")
            return
        else:
            d['leverage'] = leverage
    ...
    @validate_api_token_value
    def get_position(self, position_id=None, key=None):
        """
    ...
    @validate_api_token_value
    def update_position(self, position_id=None, stop_loss=None, stop_loss_trailing=None, take_profit=None, key=None):
        """
        Fetch information about an existing position.
    ...
    @validate_api_token_value
    def close_position(self, position_id=None, key=None):
        """
    ...
    @validate_api_token_value
    def cancel_position(self, position_id=None, key=None):
        """
    ...
    @validate_api_token_value
    def split_position(self, position_id=None, ratio=None, key=None):
        """
    ...
    @validate_api_token_value
    def list_positions(self, position_state='active', limit=5, key=None):
        """
        List positions.
